...
<template>
  ...
  <nav class="navbar bg-white navbar-expand-lg sticky-top py-2 px-0">
    <div class="container-fluid">
      <a @click.prevent="" href="" class="nav-link ms-2">
      ...
      <div class="collapse navbar-collapse row" id="navbarNavAltMarkup">
        <div class="col-9">
          <div
            v-if="page === 'home'"
            class="d-lg-flex d-md-none justify-content-center"
          >
            <div class="w-50">
              <form
        ...
        <div class="col-3">
          <div
            ...
            class="d-lg-flex d-md-block justify-content-end"
          >
            <a
              v-if="!isLogin"
              ...
              <ul class="dropdown-menu">
                <li>
                  <h6
                    ...
                    :class="isPremium ? 'text-success' : 'text-danger'"
                  >
